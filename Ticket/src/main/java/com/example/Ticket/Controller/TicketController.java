...
public class TicketController {
    ...
    description = "Tickets encontrados y devueltos.",
    content = @Content(schema = @Schema(implementation = Ticket.class)))

    @ApiResponse(responseCode = "204",
    description = "No hay tickets para devolver")

    @ApiResponse(responseCode = "500",
    description = "Error interno del servidor al intentar obtener los tickets.")
    ...
    description = "Recurso asociado no encontrado durante la creación (ej. si hay dependencias no encontradas).",
    content = @Content(schema = @Schema(implementation = String.class, example = "Error al guardar el ticket: [Mensaje del error]")))

    @ApiResponse(responseCode = "500",
    description = "Error interno del servidor al crear el ticket.")
    ...
    @ApiResponse(responseCode = "200",
    description = "Ticket encontrado y devuelto.",
    content = @Content(schema = @Schema(implementation = Ticket.class)))

    @ApiResponse(responseCode = "404",
    description = "El ticket con el ID especificado no fue encontrado.")

    @ApiResponse(responseCode = "500", 
    description = "Error interno del servidor al buscar el ticket.")
    ...
    @ApiResponse(responseCode = "404",
    description = "No se encontraron tickets para el ID de usuario especificado.")

    @ApiResponse(responseCode = "500",
    description = "Error interno del servidor al buscar los tickets.")
    ...
    @ApiResponse(responseCode = "404",
    description = "No se encontraron tickets para el ID de soporte especificado.")
    ...
    @ApiResponse(responseCode = "404",
    description = "El ticket con el ID especificado no fue encontrado para eliminar.")
    ...
    @ApiResponse(responseCode = "404",
    description = "El ticket con el ID especificado no fue encontrado para actualizar.")

    @ApiResponse(responseCode = "500", 
    description = "Error interno del servidor al actualizar el ticket.")
