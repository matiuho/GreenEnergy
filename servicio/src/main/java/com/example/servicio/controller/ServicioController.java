...
public class ServicioController {
    ...
    @ApiResponse(responseCode = "200", description = "Servicios activos encontrados y devueltos.",
                 content = @Content(schema = @Schema(implementation = Servicio.class)))
    @ApiResponse(responseCode = "204", description = "No hay servicios activos para devolver (lista vacía).")
    ...
    @ApiResponse(responseCode = "200", description = "Servicio encontrado y devuelto.",
                 content = @Content(schema = @Schema(implementation = Servicio.class)))
    @ApiResponse(responseCode = "404", description = "El servicio con el ID especificado no fue encontrado.")
    ...
    @ApiResponse(responseCode = "400", description = "Solicitud inválida debido a validaciones de longitud fallidas.",
                 content = @Content(schema = @Schema(implementation = String.class, example = "El Nombre debe Contener entre 1 y 20 Caracteres")))
    ...
    @ApiResponse(responseCode = "200", description = "Servicio actualizado exitosamente.",
                 content = @Content(schema = @Schema(implementation = Servicio.class)))
    @ApiResponse(responseCode = "404", description = "El servicio con el ID especificado no fue encontrado para actualizar.")
    ...
    @ApiResponse(responseCode = "404", description = "El servicio con el ID especificado no fue encontrado para eliminar.")
    @ApiResponse(responseCode = "500", description = "Error interno del servidor al intentar eliminar el servicio.")
    ...
    @ApiResponse(responseCode = "200", description = "Servicio desactivado exitosamente.",
                 content = @Content(schema = @Schema(implementation = Servicio.class)))
    @ApiResponse(responseCode = "404", description = "El servicio no fue encontrado o no se pudo desactivar.")
    ...
    @ApiResponse(responseCode = "200", description = "Servicio activado exitosamente.",
                 content = @Content(schema = @Schema(implementation = Servicio.class)))
    @ApiResponse(responseCode = "404", description = "El servicio no fue encontrado o no se pudo activar.")
    @ApiResponse(responseCode = "500", description = "Error interno del servidor al intentar activar el servicio.")
